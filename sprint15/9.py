...
class DynastyExperienceCounter:
    ...
    def count_dynasty_experience(self):
        ...
        if self.root.mother:
            mother = DynastyExperienceCounter(self.root.mother)
            self.total_experience += mother.count_dynasty_experience()
        if self.root.father:
            father = DynastyExperienceCounter(self.root.father)
            self.total_experience += father.count_dynasty_experience()
