...
assert test_old_none_programmer.programmer_define() == expected_string, (
    'Метод programmer_define неправильно присваивает статус'
)

expected_age = 'Старейшина'
assert test_old_none_programmer.age_define() == expected_age, (
...
assert test_young_yes_programmer.programmer_define() == expected_string, (
    'Метод programmer_define неправильно присваивает статус'
)

expected_age = 'Молодой'
assert test_young_yes_programmer.age_define() == expected_age, (
    'Метод age_define неправильно опрделеяет возраст'
)
...
assert test_mid_yes_programmer.age_define() == expected_age, (
    'Метод age_define неправильно опрделеяет возраст'
)
